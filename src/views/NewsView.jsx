...
import { loadArticles, loadOutlets, loadArticleDetail } from '../lib/supabase'

// News Feed: the live ingested article stream across all outlets — search,
// outlet filter, and arc-assignment status. This is the surface for the
// hundreds of articles the RSS pipeline pulls in every 24h.
          ...
          <li key={a.id} className="news-item">
            <button className="news-card" onClick={() => toggleExpand(a.id)}>
              ...
              <div className="news-badges">
                ...
                {a.arc_title && <span className="news-badge arc">arc: {a.arc_title}</span>}
